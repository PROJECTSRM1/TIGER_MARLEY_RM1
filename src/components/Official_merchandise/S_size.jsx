...
const initialProducts = [
  { id: 1, name: "Eat Sleep Code Repeat Half Sleeve T-Shirt", image: require("../../assets/xl_xxl_xs_images/s1.jpg"), oldPrice: 1199, newPrice: 599 },
  { id: 2, name: "Keep Calm And Code On Half Sleeve T-Shirt", image: require("../../assets/xl_xxl_xs_images/s2.jpg"), oldPrice: 1199, newPrice: 599 },
  { id: 3, name: "Future Programmer Half Sleeve Unisex Tee", image: require("../../assets/xl_xxl_xs_images/s3.jpg"), oldPrice: 1199, newPrice: 599 },
  { id: 4, name: "Trust Me I Write Code Half Sleeve T-Shirt", image: require("../../assets/xl_xxl_xs_images/s4.jpg"), oldPrice: 1199, newPrice: 499 },
  { id: 5, name: "Debugging Is My Cardio Half Sleeve Tee", image: require("../../assets/xl_xxl_xs_images/s5.jpg"), oldPrice: 1199, newPrice: 699 },
  { id: 6, name: "Code Hard Or Go Home Unisex T-Shirt", image: require("../../assets/xl_xxl_xs_images/s6.jpg"), oldPrice: 1199, newPrice: 549 },
];
